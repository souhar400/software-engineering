...
public class Recordtest extends RelativeLayout {
    ...
    public Recordtest(Context context) {
        super(context);
        init();
    }

    public Recordtest(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public Recordtest(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
