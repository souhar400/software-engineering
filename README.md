...
```
cd existing_repo
git remote add origin https://git.fh-muenster.de/kling-klang/kling-klang-e.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.fh-muenster.de/kling-klang/kling-klang-e/-/settings/integrations)
